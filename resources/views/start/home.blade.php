...
<section class="hero-section">
    ...
    <div class="hero-container">
        <div class="hero-left fade-in">
            ...
            <p class="hero-instansi">
                Dinas Pemberdayaan Perempuan dan Perlindungan Anak<br>Kota Banjarmasin
            </p>
            <div class="hero-narasi">
                <p>
                    Hadir untuk <strong>mengintegrasikan data perencanaan</strong> dan mempermudah
                    pencarian arsip. Dilengkapi fitur pemantauan kinerja unit kerja secara <em>real-time</em>.
                </p>
            </div>
        ...
        <div class="news-grid">
            ...
            <div class="news-card reveal">
                <div class="card-img-wrapper">
                    ...
                    >
                    <span class="card-badge {{ $item->badge_color }}">{{ $item->badge_label }}</span>
                </div>
                <div class="card-body">
                    <div class="card-date">
    ...
    <div class="container">
        ...
        <div class="location-card reveal">
            <div class="loc-image-map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.2158585496113!2d114.60134577449834!3d-3.2966582411273055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de4239c50810335%3A0x31a8371931372e41!2sDinas%20Pemberdayaan%20Perempuan%20dan%20Perlindungan%20Anak%20Kota%20Banjarmasin!5e0!3m2!1sid!2sid!4v1770844501847!5m2!1sid!2sid"
            ...
            <div class="loc-info">
                ...
                <p class="address">
                    ...
                    Gedung Capil, Jl. Sultan Adam No.49, Surgi Mufti, Kec. Banjarmasin Utara,
